...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post connections_url, params: { connection: { ip_address: @connection.ip_address, password: @connection.password, user_id: @connection.user_id, username: @connection.username } }
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { ip_address: @connection.ip_address, password: @connection.password, user_id: @connection.user_id, username: @connection.username } }
