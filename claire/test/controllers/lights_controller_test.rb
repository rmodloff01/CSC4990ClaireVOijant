...
class LightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create light" do
    assert_difference('Light.count') do
      post lights_url, params: { light: { file_name: @light.file_name, status: @light.status } }
    end
  ...
  test "should update light" do
    patch light_url(@light), params: { light: { file_name: @light.file_name, status: @light.status } }
